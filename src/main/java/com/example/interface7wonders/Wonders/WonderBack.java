...
public class WonderBack extends WonderPiece{
    ...
    public ArrayList<WonderPiece> listEpheseB = new ArrayList<>(5){{
        ...
        new WonderBack("Ephèse",2,false,3,true);
        new WonderBack("Ephèse",2,false,3,false);
        new WonderBack("Ephèse",3,false,4,true);
    }};
    public ArrayList<WonderPiece> listBabylonB = new ArrayList<>(5){{
        ...
        new WonderBack("Babylon",4,false,4,true);
    }};
    ...
    public ArrayList<WonderPiece> listHallicarnasB = new ArrayList<>(5){{
        ...
        new WonderBack("Halicarnasse",3,false,3,false);
        new WonderBack("Halicarnasse",4,false,4,true);
    }};
    public ArrayList<WonderPiece> listRhodesB = new ArrayList<>(5){{
        new WonderBack("Rhodes",1,false,2,true);
        new WonderBack("Rhodes",1,false,2,false);
        new WonderBack("Rhodes",2,false,3,true);
        new WonderBack("Rhodes",3,false,3,false);
        new WonderBack("Rhodes",4,false,4,true);
    }};
    public ArrayList<WonderPiece> listOlympieB = new ArrayList<>(5){{
        ...
        new WonderBack("Olympie",2,false,3,true);
        new WonderBack("Olympie",3,false,3,false);
        new WonderBack("Olympie",4,false,4,true);
    }};

    public WonderBack(String nomMerveille, int etage, boolean state, int nbRessources, boolean different) {
